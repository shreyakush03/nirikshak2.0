...
- **Primary** (#FF4F00): Primary CTAs, add-to-cart buttons, active navigation
...
- **Product Hover:** 14px offset, 32px blur, #FF4F00 at 12%; 6px offset, 12px blur, #000000 at 6% — Fuchsia-tinted lift on product cards

## Components

### Buttons
**Primary (Filled)** — `bg: #FF4F00`, `text: #FFFFFF`, `font: Nunito 15px/700`, `padding: 12px 28px`, `radius: 9999px`, `hover: #C026D3`, `active: #A21CAF`
**Secondary (Outline)** — `bg: transparent`, `text: #FF4F00`, `border: 2px #FF4F00`, `radius: 9999px`, `hover: bg #FDF4FF`
...
### Inputs
**Text Input** — `bg: #FFFFFF`, `border: 1.5px #D4D4D4`, `text: #171717`, `placeholder: #A3A3A3`, `radius: 12px`, `padding: 0 16px`, `height: 44px`, `font: Nunito 16px/400`, `focus: border #FF4F00, ring 3px ring #FF4F00 at 15%, `error: border #EF4444, ring #EF4444 at 15%, `disabled: bg #F5F5F5, 50% opacity`
- **Label**: top, Nunito, 13px, 600, #171717
- **Helper text**: 12px, #525252

### Chips
**Filter Chip** — `height: 34px`, `padding: 0 14px`, `radius: 9999px`, `border: 1.5px #D4D4D4`, `selected: bg #FF4F00, text #FFFFFF, border #FF4F00`, `hover: bg #F5F5F5`
**Status Chip** — Success: `bg #DCFCE7, text #166534` / Warning: `bg #FEF9C3, text #854D0E` / Error: `bg #FEE2E2, text #991B1B`

### Lists
**Default List Item** — `height: 48px`, `padding: 0 16px`, `font: Nunito 16px/400`, `divider: 1px #E5E5E5`, `hover: bg #FAFAFA`, `selected: bg #FDF4FF, text #FF4F00`, `icon variant: 22px icon, 14px gap`

### Checkboxes
20px, border: 2px #D4D4D4, radius: 6px, checked: bg #FF4F00 border #FF4F00 with white checkmark, indeterminate: bg #FF4F00 with white dash, disabled: 40% opacity, label: Nunito 14px/400 with 10px gap.

### Radio Buttons
20px, border: 2px #D4D4D4, selected: border #FF4F00 with 6px inner dot #FF4F00, disabled: 40% opacity, label: Nunito 14px/400 with 10px gap.
