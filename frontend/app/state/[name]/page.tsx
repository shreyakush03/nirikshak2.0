...
export default function StateDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-neutral-900 antialiased selection:bg-[#FF4F00] selection:text-white">
      {/* Top Navbar */}
      <header className="border-b border-[#E5E5E5] bg-white shadow-sm sticky top-0 z-40">
      ...
      <main className="max-w-7xl mx-auto px-6 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 bg-white border border-[#E5E5E5] rounded-[24px] p-8 shadow-sm relative overflow-hidden">
            {/* Region Tag */}
            ...
            <h1 className="text-4xl sm:text-5xl font-black text-neutral-900 font-poppins tracking-tight leading-none mb-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              {/* 1. Total MPs */}
              <div className="p-4 rounded-[16px] bg-[#F5F5F5]/60 border border-[#E5E5E5] flex flex-col justify-between">
            ...
            <div className="mt-6 pt-5 border-t border-[#E5E5E5] text-xs text-neutral-500 space-y-2">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="p-6 rounded-[24px] bg-white shadow-sm border border-[#E5E5E5]">
              <h3 className="text-sm font-bold text-neutral-900 flex items-center gap-2 uppercase tracking-wider font-poppins">
              ...
              <div className="grid grid-cols-4 gap-2">
                <div className="p-3 bg-[#F5F5F5]/60 rounded-[12px] border border-[#E5E5E5]/60 text-center">
                  <span className="text-[10px] text-[#FF4F00] font-bold block uppercase">Critical</span>
                  <span className="text-xl font-bold font-space-mono text-neutral-900">{metrics.critical_count}</span>
                </div>
                <div className="p-3 bg-[#F5F5F5]/60 rounded-[12px] border border-[#E5E5E5]/60 text-center">
                  <span className="text-[10px] text-[#FACC15] font-bold block uppercase">High</span>
                  <span className="text-xl font-bold font-space-mono text-neutral-900">{metrics.high_count}</span>
                </div>
                <div className="p-3 bg-[#F5F5F5]/60 rounded-[12px] border border-[#E5E5E5]/60 text-center">
                  <span className="text-[10px] text-blue-600 font-bold block uppercase">Medium</span>
                  <span className="text-xl font-bold font-space-mono text-neutral-900">{metrics.medium_count}</span>
                </div>
                <div className="p-3 bg-[#F5F5F5]/60 rounded-[12px] border border-[#E5E5E5]/60 text-center">
                  <span className="text-[10px] text-neutral-500 font-bold block uppercase">Low</span>
            ...
            {/* Outliers Table */}
            <div className="p-6 rounded-[24px] bg-white shadow-sm border border-[#E5E5E5] space-y-4">
              <div className="flex items-center justify-between">
                <h4 className="text-xs font-bold text-neutral-800 uppercase tracking-wider flex items-center gap-2 font-poppins">
              ...
              {top_anomalies.length === 0 ? (
                <div className="p-8 text-center text-xs text-neutral-400 bg-[#F5F5F5]/40 border border-[#E5E5E5] rounded-[16px]">
                ...
                <div className="space-y-3">
                  {top_anomalies.map((item: any) => (
                    <div 
                      key={item.project_id}
                      className="p-4 rounded-[16px] bg-[#F5F5F5]/40 border border-[#E5E5E5] hover:border-[#D4D4D4] transition-colors space-y-2"
                    >
                      ...
                      <div className="text-[11px] text-[#FF4F00] font-medium bg-[#FF4F00]/10 p-2 rounded-lg border border-[#FF4F00]/20">
                        {item.primary_reason}
                      </div>
              ...
              <div className="pt-2 text-center">
                <button
                  ...
                  className="text-xs font-semibold text-[#FF4F00] hover:underline transition-colors flex items-center gap-1 mx-auto"
                >
